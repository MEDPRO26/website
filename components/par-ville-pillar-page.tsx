...
import {
  parVillePillarContent,
  type ParVilleLink,
  type ParVillePillarContent,
} from "@/lib/par-ville-pillar-content";
...
export function buildParVillePillarMetadata(
  content: ParVillePillarContent = parVillePillarContent
): Metadata {
  return {
...
function InlineLink({ link }: { link: ParVilleLink }) {
  return (
    <Link
      href={link.href}
...
export default function ParVillePillarPage({
  content = parVillePillarContent,
}: {
  content?: ParVillePillarContent;
}) {
    ...
    <>
      ...
      <main className="flex-1 pb-20 pt-[calc(var(--site-header-offset,4rem)+0.5rem)] md:pb-0">
        <section className="relative min-h-[70vh] overflow-hidden">
          ...
          <div className="relative z-10 mx-auto flex min-h-[70vh] max-w-7xl flex-col justify-end px-4 pb-12 pt-24 sm:px-6 sm:pb-16 lg:pb-20">
          ...
          <div className="mx-auto max-w-5xl">
            ...
            <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
              {content.cities.map((city) => (
                <article
                  key={city.slug}
                  className="flex flex-col border-b border-outline-variant/40 pb-6 sm:border sm:border-outline-variant/30 sm:rounded-2xl sm:bg-white sm:p-6 sm:pb-6"
                >
                  ...
                  {city.zonesHint ? (
                    <p className="font-body mb-4 text-xs text-on-surface-variant/80">
                      Zones : {city.zonesHint}
                    </p>
                  ) : null}
                  <div className="mt-auto flex flex-col gap-2">
                    ...
                    <div className="flex flex-wrap gap-3 text-xs">
                      <Link
                        ...
                        className="font-heading font-semibold text-primary/80 hover:underline"
                      >
                        {city.locationLabel}
                      </Link>
                      <Link
          ...
          <div className="mx-auto flex max-w-5xl flex-col items-start gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="max-w-xl">
              ...
              <p className="font-body text-base text-white/85">
                Indiquez votre ville et votre besoin : SOS Santé Maroc vérifie
        ...
        <section className="px-4 py-14 sm:px-6 lg:py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <PillarSectionImage image={content.sectionImages?.structure} />
            <p className="font-body mb-10 max-w-3xl text-base text-on-surface-variant sm:text-lg">
              {content.structureIntro}
            </p>
            <div className="grid gap-8 sm:grid-cols-2">
              {content.structureBlocks.map((block) => (
                <div key={block.title}>
        ...
        <section className="bg-surface-container-low px-4 py-14 sm:px-6 lg:py-20">
          <div className="mx-auto max-w-5xl">
            <h2 className="font-heading mb-10 text-2xl font-semibold text-primary sm:text-3xl">
        ...
        <section className="px-4 py-14 sm:px-6 lg:py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <PillarSectionImage image={content.sectionImages?.architecture} />
            <div className="grid gap-8 md:grid-cols-3">
              {content.architectureBlocks.map((block) => (
                <div key={block.title}>
        ...
        <section className="bg-surface-container-low px-4 py-14 sm:px-6 lg:py-20">
          <div className="mx-auto max-w-5xl">
            ...
            <PillarSectionImage image={content.sectionImages?.related} />
        ...
        <section className="px-4 py-16 sm:px-6 lg:py-24">
          <div className="mx-auto max-w-5xl text-center">
            ...
            <div className="flex flex-col items-center justify-center gap-3 sm:flex-row">
              <WhatsAppCta href={whatsapp} label="Demander sur WhatsApp" />
              <a
                href="#villes"
