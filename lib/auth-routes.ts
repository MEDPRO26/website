...
export const APPORT_AFFAIRES_HONORAIRES_PATH = "/apport-affaires/honoraires";
export const APPORT_AFFAIRES_DEMANDES_PATH = "/apport-affaires/demandes";
export const APPORT_AFFAIRES_PUSH_PATH = "/apport-affaires/push";
